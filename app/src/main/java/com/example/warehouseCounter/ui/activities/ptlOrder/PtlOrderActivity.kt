...
import com.example.warehouseCounter.data.ktor.v1.functions.AddBoxToOrder
import com.example.warehouseCounter.data.ktor.v1.functions.AttachOrderToLocation
import com.example.warehouseCounter.data.ktor.v1.functions.BlinkAllOrder
import com.example.warehouseCounter.data.ktor.v1.functions.BlinkOneItem
import com.example.warehouseCounter.data.ktor.v1.functions.DetachOrderToLocation
import com.example.warehouseCounter.data.ktor.v1.functions.GetPtlOrderByCode
import com.example.warehouseCounter.data.ktor.v1.functions.GetPtlOrderContent
import com.example.warehouseCounter.data.ktor.v1.functions.PickManual
import com.example.warehouseCounter.data.ktor.v1.functions.PrintBox
...
import com.example.warehouseCounter.databinding.PtlOrderActivityBottomPanelCollapsedBinding
...
import com.example.warehouseCounter.ui.adapter.ptlOrder.PtlContentAdapter
...
import com.example.warehouseCounter.ui.fragments.ptlOrder.PtlOrderHeaderFragment
...
class PtlOrderActivity : AppCompatActivity(), PtlContentAdapter.EditQtyListener,
        ...
        if (oldOrder == null || oldOrder == ptlOrder) {
            ...
            thread {
                DetachOrderToLocation(
                    ...
                    onEvent = { if (!SUCCESS.equals(it.snackBarType)) showMessage(it.text, it.snackBarType) },
                    onFinish = {
    ...
    private fun addBox() {
        ...
        thread {
            ...
            }, onEvent = { if (!SUCCESS.equals(it.snackBarType)) showMessage(it.text, it.snackBarType) }).execute()
        }
    }
