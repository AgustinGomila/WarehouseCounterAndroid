package com.example.warehouseCounter.ui.activities.linkCode
...
import com.example.warehouseCounter.databinding.LinkCodeActivityBottomPanelCollapsedBinding
        ...
        if (adapter?.currentItem() != null) {
            ...
            if (item != null) {
                ...
                try {
                    ...
                    showMessage(context.getString(R.string.invalid_amount), ERROR)
                    return
                }
