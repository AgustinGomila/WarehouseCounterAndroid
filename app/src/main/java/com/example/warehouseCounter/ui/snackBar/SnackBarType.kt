...
class SnackBarType : Parcelable {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other != null && other is Int) return snackBarTypeId == other
    ...
    companion object CREATOR : Parcelable.Creator<SnackBarType> {
        ...
        fun getFinish(): ArrayList<Int> {
            val allSections = ArrayList<Int>()
            Collections.addAll(allSections, ERROR.snackBarTypeId, SUCCESS.snackBarTypeId)
            return ArrayList(allSections.sortedWith(compareBy { it }))
        }

        fun getFinishType(): ArrayList<SnackBarType> {
            val allSections = ArrayList<SnackBarType>()
