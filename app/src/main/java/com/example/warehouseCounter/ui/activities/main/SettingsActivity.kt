...
import com.example.warehouseCounter.data.settings.utils.QRConfigType.CREATOR.QRConfigWebservice
...
import com.example.warehouseCounter.databinding.SettingsActivityBinding
...
class SettingsActivity : AppCompatActivity(), PreferenceFragmentCompat.OnPreferenceStartFragmentCallback,
    ...
    override fun onTaskConfigPanelEnded(status: ProgressStatus) {
        if (status == ProgressStatus.finished) {
            showMessage(getString(R.string.configuration_applied), INFO)
            removeDataBases()
            finish()
    ...
    companion object {
        ...
        private val commonPreferenceChangeListener = Preference.OnPreferenceChangeListener { preference, value ->
            ...
            if (preference is ListPreference) {
                ...
                preference.summary = if (index >= 0) preference.entries[index]
                else null
            } else {
        ...
        fun bindPreferenceSummaryToValue(
            ...
            pref: com.example.warehouseCounter.data.settings.Preference,
        ) {
