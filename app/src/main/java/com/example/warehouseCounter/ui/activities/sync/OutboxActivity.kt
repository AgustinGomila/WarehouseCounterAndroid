package com.example.warehouseCounter.ui.activities.sync
...
import com.example.warehouseCounter.data.io.IOFunc.Companion.completeCompletedPath
...
import com.example.warehouseCounter.data.io.IOFunc.Companion.writeToFile
...
import com.example.warehouseCounter.databinding.OutboxActivityBinding
...
import com.example.warehouseCounter.ui.activities.orderRequest.OrderRequestDetailActivity
import com.example.warehouseCounter.ui.adapter.orderRequest.OrderRequestAdapter
...
class OutboxActivity : AppCompatActivity() {
    ...
    private fun removeSelected(toRemove: ArrayList<OrderRequest>) {
        ...
        if (!isOk) {
            showMessage(getString(R.string.an_error_occurred_while_trying_to_delete_the_count), ERROR)
        }
