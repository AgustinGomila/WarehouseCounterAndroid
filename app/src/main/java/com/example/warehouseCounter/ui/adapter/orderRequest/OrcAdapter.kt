package com.example.warehouseCounter.ui.adapter.orderRequest
...
import com.example.warehouseCounter.data.ktor.v2.dto.order.ContentStatus
...
import com.example.warehouseCounter.databinding.OrcRowBinding
import com.example.warehouseCounter.databinding.OrcRowExpandedBinding
...
class OrcAdapter private constructor(builder: Builder) :
    ...
    fun updateDescription(item: OrderRequestContent, desc: String) {
        val itemId: Long = item.itemId ?: return
    ...
    private fun reportQtyCollectedChange(content: OrderRequestContent) {
        ...
        showMessage(res, SnackBarType.ADD)
    }
    ...
    private fun reportQtyRequestedReached(content: OrderRequestContent) {
        ...
        showMessage(res, SnackBarType.UPDATE)
    }
