package com.example.warehouseCounter.ui.activities.common
...
import com.example.warehouseCounter.databinding.QtySelectorBinding
import com.example.warehouseCounter.misc.objects.errorLog.ErrorLog
import com.example.warehouseCounter.misc.utils.NumberUtils.Companion.round
        ...
        if (equals(scanCode, orc.ean)) {
            try {
                ...
                try {
                    ...
                    showMessage(e.message.toString(), ERROR)
                    return
                }
