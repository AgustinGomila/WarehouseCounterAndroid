package com.example.warehouseCounter.ui.fragments.main
...
import com.example.warehouseCounter.databinding.HomeActivityButtonPage1Binding
import com.example.warehouseCounter.databinding.HomeActivityButtonPage2Binding
import com.example.warehouseCounter.misc.Statics
import com.example.warehouseCounter.ui.activities.main.HomeActivity
...
import com.example.warehouseCounter.ui.utils.Colors
    ...
    private fun setupButton(button: Button) {
        button.setOnClickListener {
            try {
                ...
                ex.printStackTrace()
                showMessage("${getString(R.string.exception_error)}: " + ex.message, SnackBarType.ERROR)
            }
        }
