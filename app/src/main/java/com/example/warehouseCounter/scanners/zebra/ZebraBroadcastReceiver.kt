...
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.DATA_WEDGE_INTENT_KEY_DATA
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_COMMAND
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_CONFIGURATION_UPDATE
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_NOTIFICATION_PROFILE_NAME
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_NOTIFICATION_STATUS
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_PROFILE_SWITCH
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_SCANNER_STATUS
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_RESULT
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_RESULT_GET_VERSION_INFO
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_RESULT_INFO
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_RESULT_NOTIFICATION
import com.example.warehouseCounter.scanners.zebra.Zebra.Constants.EXTRA_RESULT_NOTIFICATION_TYPE
