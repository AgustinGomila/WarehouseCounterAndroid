...
import com.example.warehouseCounter.data.ktor.v2.impl.ApiPaginationParam.Companion.defaultPagination
...
class GetItemCode(
    ...
    private val onFinish: (ArrayList<ItemCode>) -> Unit,
) {
    ...
    private var r: ArrayList<ItemCode> = ArrayList()
    ...
    fun execute() {
        ...
        sendEvent(context.getString(R.string.searching_item_codes), SnackBarType.RUNNING)
        scope.launch {
            coroutineScope {
