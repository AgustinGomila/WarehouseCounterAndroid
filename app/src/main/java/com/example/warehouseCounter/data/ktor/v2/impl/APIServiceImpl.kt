...
import com.example.warehouseCounter.data.ktor.v2.dto.barcode.BarcodeCodeParam
...
import com.example.warehouseCounter.data.ktor.v2.dto.order.OrderLocation
...
import com.example.warehouseCounter.data.ktor.v2.dto.order.OrderUpdatePayload
...
import com.example.warehouseCounter.data.ktor.v2.impl.ApiRequest.Companion.ORDER_PACKAGE_PATH
...
import com.example.warehouseCounter.data.ktor.v2.service.APIService
...
class APIServiceImpl : APIService {
     ...
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/database/)
     ...
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/rack/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/warehouse_area/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/warehouse/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/barcode-label-template)
     ...
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/order/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/order_package/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/item/)
     ...
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/order_location/)
     ...
     * @param callback [APIResponse] of desired list of objects
     *
     * [Manual](http://manual.example.com/warehouse_counter/software/API/v2/item-code/)
