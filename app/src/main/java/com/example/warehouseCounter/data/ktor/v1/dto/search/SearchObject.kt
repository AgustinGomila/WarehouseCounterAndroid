package com.example.warehouseCounter.data.ktor.v1.dto.search
 ...
 * por la interface de la API: [com.example.warehouseCounter.data.ktor.v1.impl.APIServiceImpl.getPrices]
 */
@Serializable
class SearchObject() {
