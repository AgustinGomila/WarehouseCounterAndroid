...
import com.example.warehouseCounter.WarehouseCounterApp.Companion.syncVm
import com.example.warehouseCounter.data.ktor.v2.functions.itemCode.SendItemCodeArray
...
import com.example.warehouseCounter.data.room.database.helper.DownloadStatus.CANCELED
import com.example.warehouseCounter.data.room.database.helper.DownloadStatus.CRASHED
import com.example.warehouseCounter.data.room.database.helper.DownloadStatus.FINISHED
import com.example.warehouseCounter.data.room.database.helper.DownloadStatus.STARTING
...
class DownloadDb private constructor(builder: Builder) : DownloadFileTask.OnDownloadFileTask {
    ...
    private var mCallback: DownloadDbTask = builder.callBack
