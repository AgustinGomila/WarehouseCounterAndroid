...
class WarehouseCounterApp : Application(), KoinComponent {
    ...
    companion object {
        ...
        val apiServiceV1: com.example.warehouseCounter.data.ktor.v1.impl.APIServiceImpl by lazy { get().get() }
        val dacoService: DacoServiceImpl by lazy { get().get() }
        val apiServiceV2: com.example.warehouseCounter.data.ktor.v2.impl.APIServiceImpl by lazy { get().get() }
