...
class GetPtlOrder(
    ...
    private suspend fun suspendFunction() = withContext(Dispatchers.IO) {
        ...
        val tempInst = apiService.getPtlOrder(body = body)
        ...
        tempInst.enqueue(object : Callback<Any?> {
            override fun onResponse(call: Call<Any?>, response: Response<Any?>) {
                ...
                try {
                    ...
                    sendEvent(context.getString(R.string.invalid_orders), SnackBarType.ERROR)
                }
            }
    ...
    private fun getBody(): RequestBody {
        ...
        jsonParam.put("userToken", Statics.Token.token)
