...
class PickManual(
    ...
    private suspend fun suspendFunction() = withContext(Dispatchers.IO) {
        ...
        val tempInst = apiService.pickManual(body = body)
        ...
        tempInst.enqueue(object : Callback<Any?> {
            override fun onResponse(call: Call<Any?>, response: Response<Any?>) {
                ...
                try {
                    val respObj = moshi.adapter(PickManualResponse::class.java).fromJsonValue(resp)
                    if (respObj == null) {
                        onEvent.invoke(
                            SnackBarEventData(
                    ...
                    val r: ArrayList<PickItem> = ArrayList(respObj.contents)
