...
import com.dacosys.warehouseCounter.data.ktor.v2.dto.order.OrderResponseContent.CREATOR.CONTENT_RESPONSE_LIST_KEY
...
data class OrderResponse(
    ...
    @SerialName(PROCESSED_DATE_KEY) var processedDate: String? = null,
    @SerialName(PROCESSED_KEY) var processed: String = "",
    @SerialName(RECEIVED_DATE_KEY) var receivedDate: String? = null,
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (processedDate?.hashCode() ?: 0)
