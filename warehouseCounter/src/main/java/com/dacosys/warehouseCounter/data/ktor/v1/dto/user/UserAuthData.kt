package com.dacosys.warehouseCounter.data.ktor.v1.dto.user
 ...
 * por la interface de la API: [com.dacosys.warehouseCounter.data.ktor.v1.impl.APIServiceImpl.getToken]
 */
