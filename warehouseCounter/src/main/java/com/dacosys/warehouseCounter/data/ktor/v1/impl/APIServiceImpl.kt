...
import com.dacosys.warehouseCounter.data.ktor.v1.dto.ptlOrder.ApiResponse.Companion.RESULT_ERROR
...
class APIServiceImpl : APIService {
    ...
    override suspend fun getDbLocation(
        ...
        var res: ArrayList<com.dacosys.warehouseCounter.data.ktor.v1.dto.database.DatabaseData> = ArrayList()
        val result: String
        try {
            result = httpClient.post {
                url(url)
            ...
            val inter =
                json.decodeFromString<com.dacosys.warehouseCounter.data.ktor.v1.dto.database.DatabaseDataIntermediate>(
                    result
                )
