...
class CommandCode : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<CommandCode> {
        ...
        var GetVersion = CommandCode(0x02.toByte(), "GetVersion")
        ...
        var ReadHandsetParam = CommandCode(0x06.toByte(), "ReadHandsetParam")
        ...
        var WriteHandlerParam = CommandCode(0x09.toByte(), "WriteHandlerParam")

        var SetReaderMode = CommandCode(0x0b.toByte(), "SetReaderMode")
        private var WriteFactoryParam = CommandCode(0x0c.toByte(), "WriteFactoryParam")
        var ReadFactoryParameter = CommandCode(0x0d.toByte(), "ReadFactoryParameter")
        ...
        var SetBluetoothName = CommandCode(0x8d.toByte(), "SetBluetoothName")
        var GetBluetoothName = CommandCode(0x8e.toByte(), "GetBluetoothName")
