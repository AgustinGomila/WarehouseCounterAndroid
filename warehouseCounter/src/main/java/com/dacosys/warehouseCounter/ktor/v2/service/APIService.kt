...
interface APIService {
    ...
    suspend fun viewRack(
        id: Long, action: ArrayList<ApiActionParam>, callback: (Rack?) -> Unit
    )

    suspend fun getRack(
        filter: ArrayList<ApiFilterParam>, action: ArrayList<ApiActionParam>, callback: (ListResponse<Rack>) -> Unit
    )

    suspend fun getRackBarcode(params: BarcodeParam, callback: (List<Barcode>) -> Unit)

    suspend fun viewWarehouseArea(
        id: Long, action: ArrayList<ApiActionParam>, callback: (WarehouseArea?) -> Unit
    )
    ...
    suspend fun viewWarehouse(
        id: Long, action: ArrayList<ApiActionParam>, callback: (Warehouse?) -> Unit
    )
    ...
    suspend fun viewBarcodeLabelTemplate(
        id: Long, action: ArrayList<ApiActionParam>, callback: (BarcodeLabelTemplate?) -> Unit
    )
    ...
    suspend fun viewOrder(
        id: Long, action: ArrayList<ApiActionParam>, callback: (OrderResponse?) -> Unit
    )
    ...
    suspend fun viewItem(
        id: Long, action: ArrayList<ApiActionParam>, callback: (Item?) -> Unit
    )
