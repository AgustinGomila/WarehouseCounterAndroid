...
import com.dacosys.warehouseCounter.ktor.v1.dto.user.AuthData
import com.dacosys.warehouseCounter.ktor.v1.dto.user.UserAuthData.Companion.USER_AUTH_KEY
...
class SendOrder(
    ...
    private suspend fun suspendFunction() = withContext(Dispatchers.IO) {
        ktorApiServiceV1.sendOrders(body = getBody(), callback = {
