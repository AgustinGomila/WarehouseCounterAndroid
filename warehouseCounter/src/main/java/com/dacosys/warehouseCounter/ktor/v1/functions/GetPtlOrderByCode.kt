...
import com.dacosys.warehouseCounter.ktor.v1.dto.ptlOrder.PtlOrderBody
import com.dacosys.warehouseCounter.ktor.v1.dto.search.SearchItem
...
class GetPtlOrderByCode(
    ...
    private suspend fun suspendFunction() = withContext(Dispatchers.IO) {
        ...
        ktorApiServiceV1.getPtlOrderByCode(body = body, callback = {
